...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/styleWalker.css') }}">
    <link rel="shortcut icon" href="img/favicon.ico" type="image/x-icon">
    <link href="https://fonts.googleapis.com/css?family=Ropa+Sans" rel="stylesheet">
    <title>Сервис для выгула собак "Walkie-Doggie"</title>
    <meta name="description" content="Сервис для выгула собак Walkie-Doggie поможет вам выгулять вашу собаку, если у вас нет свободного времени или возникли непредвиденные обстоятельства. Также наш сервис предоставляет отличную возможность найти несложную и приятную подработку">
    ...
    <div class="footer__container">
        <div class="container__item">
            ...
            <ul>                                                    
                ...
                <li><a href="#job">О работе</a>
                <li><a href="#walkers">Наши волкеры</a>
    ...
    <div class="footer__zag">
        <div class="zag__block">
            <span class="block__span">
                Сервис дял выгул собак "Walkie-Doggie"<br />
                &copy; 2018
            </span>
        </div>
    </div>
</footer>
<script src="js/scriptWalker.js"></script>
</body>
</html>
